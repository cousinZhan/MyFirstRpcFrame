...
import com.doak.common.config.ProviderConfig;
import com.doak.common.spring.ServiceBean;
import com.doak.common.utils.ReflectUtils;
...
import static com.doak.common.constants.CommonConstants.HIDE_KEY_PREFIX;

/**
 * @author ：zhanyiqun
 * @date ：Created in 2020/9/23 7:51
 * @description：框架bean对象定义解析器
 */
public class FrameBeanDefinitionParser implements BeanDefinitionParser {

    private Class<?> beanClass;
    private boolean required;


    public FrameBeanDefinitionParser(Class<?> beanClass, boolean required) {
        this.beanClass = beanClass;
        this.required = required;
    }

    /**
     * 自定义解析方法， 对XML的Element解析，转换成BeanDefinition返回给spring
     */
...
//            parseNested(element, parserContext, ReferenceBean.class, false, "reference", "consumer", id, beanDefinition);
        ...
        for (Method setter : beanClass.getMethods()) {
            ...
            if (name.length() > 3 && name.startsWith("set")
                ...
                String property = camelToSplitName(beanProperty, "-");
                props.add(property);
